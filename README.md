...
- EVERYTHING is written in Golang, with the default packages so far

## USE OF AI 
- Because this is a passion project, GenAI is minimally used here.
- Ideally, if this becomes bigger, I will leverage it to be productive
- HOWEVER, because I am trying to learn & have a reason to write manual code, I won't let agents have all the fun lol
